package application;
//ogrenci odeme formu yonetici icin
...
public class OgrenciUcret2Controller {
	Connection baglanti=null;
	PreparedStatement sorgu=null;
	ResultSet getir=null;
	String sql;
	
	public OgrenciUcret2Controller() {
    ...
    void TabloOgrenci_MouseClick(MouseEvent event) {
		...
		textAD.setText(bilgi2.getSOYAD());
		textucret.setText(String.valueOf(bilgi2.getUCRET()));
